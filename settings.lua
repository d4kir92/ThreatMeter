...
function ThreatMeter:InitSettings()
	TMTAB = TMTAB or {}
	ThreatMeter:SetVersion(AddonName, 132117, "0.4.37")
	tm_settings = ThreatMeter:CreateFrame(
		{
			...
			["sw"] = 520,
			["sh"] = 520,
			["title"] = format("ThreatMeter |T132117:16:16:0:0|t v|cff3FC7EB%s", "0.4.37")
		}
	)
		...
		if event == "PLAYER_LOGIN" then
			...
			C_Timer.After(
				...
				function()
					...
					ThreatMeter:CreateMinimapButton(
						{
							...
							["var"] = mmbtn,
							["dbtab"] = TMTAB,
							["vTT"] = {{"ThreatMeter |T132117:16:16:0:0|t", "v|cff3FC7EB0.4.37"}, {"Leftclick", "Open Settings"}, {"Rightclick", "Unlock/lock Text"}, {"Shift + Rightclick", "Hide Minimap Icon"}},
							["funcL"] = function()
					...
					if ThreatMeter:GV(TMTAB, "showMMBtn", ThreatMeter:GetWoWBuild() ~= "RETAIL") then
						ThreatMeter:ShowMMBtn("ThreatMeter")
					else
						ThreatMeter:HideMMBtn("ThreatMeter")
					end
